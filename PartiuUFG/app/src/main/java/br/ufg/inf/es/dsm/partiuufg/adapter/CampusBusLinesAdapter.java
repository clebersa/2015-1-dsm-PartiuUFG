 ...
 */
public class CampusBusLinesAdapter extends RecyclerView.Adapter<CampusBusLinesAdapter.CampusBusLineViewHolder> {
    private List<BusLine> busLines;
    private Context context;

    public CampusBusLinesAdapter(List<BusLine> busLines, Context context) {
